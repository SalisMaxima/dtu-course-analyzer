# Archived minimal UI redesign

Status: archived on 2026-09-05. The original UI is the preferred design.

After trying the redesign, the user preferred the original rough style, including its imperfections, because the new style felt too “AI generated / artificial.” The original's roughness and irregularities are part of its appeal. Future styling work should preserve that character and the use of colors to indicate score values.
